...
const steps = [
    {
        ...
        icon: Database,
        desc: 'SHREEG Preference Bonds are issued and held directly in your Demat account through authorized depository mechanisms. No third-party holding, no pooled accounts—your investment remains fully mapped to your Demat.',
        color: 'teal'
    },
    {
        number: '02',
        ...
        desc: 'Once the bonds are credited, SHREEG manages capital deployment through a research-driven and risk-controlled framework. Your holdings remain visible at all times and can be monitored just like any listed security.',
        color: 'blue'
    },
    {
        number: '03',
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-24">
                    ...
                    <p className="text-gray-500 font-medium max-w-2xl mx-auto leading-relaxed italic">
                        No new account required. SHREEG integrates seamlessly with India's most trusted brokerage platforms via your existing Demat infrastructure.
                    </p>
                </div>
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative group">
                            ...
                            <div className="bg-white/5 backdrop-blur-md rounded-[40px] p-10 border border-white/10 relative z-10 flex flex-col items-center text-center">
                                ...
                                <p className="text-gray-400 text-sm font-medium">Monitor your SHREEG portfolio alongside your equity holdings in any trading app.</p>
