    ...
    <View style={styles.headerWrapper}>
        <View style={styles.headerTop}>
            <View>
                ...
                <Text style={styles.headerInfo}>Corp.Office : 11WS2 Mani Casadona, Action Area 2 Rajarhat Newtown Kolkata(W.B) CIN: U74140CT2016PLC002054</Text>
            </View>
            <View style={styles.logoContainer}>
                <Image src="/shreeg_logo.png" style={{ width: 60, height: 30 }} />
            </View>
        </View>
    ...
    return (
        <Document>
            ...
            <Page size="A4" style={styles.page}>
                ...
                <Text style={[styles.bold, { fontSize: 7.5, marginBottom: 3, marginTop: 4 }]}>BANK DETAILS MANDATORY FOR PAYMENT OF DIVIDEND AND REFUND ORDER</Text>
                <View style={styles.table}>
                    <View style={styles.tableRow}>
                        ...
                        <View style={styles.tableCell}><Text>IFSC Code</Text><Text style={styles.bold}>{data.bank_details?.ifscCode}</Text></View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={[styles.tableCell, { flex: 2 }]}><Text>A/C NO.</Text><Text style={styles.bold}>{data.bank_details?.accountNumber}</Text></View>
                        <View style={styles.tableCell}><Text>Account Type</Text><Text style={styles.bold}>{data.bank_details?.accountType || 'Savings'}</Text></View>
                    </View>
                </View>
            ...
            <Page size="A4" style={styles.page}>
                ...
                <Text>Sr. No: {generateSerialNumber()}</Text>
                <Text style={styles.paragraph}>
                ...
                <Text style={{ marginLeft: 10 }}>Number of Preference bond Shares: {data.number_of_shares} ({numberInWords(data.number_of_shares).replace(' RUPEES ONLY', '')})</Text>
            </Page>

            {/* PAGE 3: TRANSACTIONAL DETAILS & MORE TERMS */}
            <Page size="A4" style={styles.page}>
                <HeaderSnippet />
                ...
                <Text style={styles.sectionHeading}>9. Management and Control:</Text>
                <Text style={styles.paragraph}>(a) The Company shall have the exclusive right to manage and control the business of the Company and to make all decisions regarding the same.</Text>
                ...
                <Text style={{ marginTop: 10, fontWeight: 'bold' }}>IN WITNESS WHEREOF, the parties hereto have executed this Agreement as of the date first above written.</Text>

                <View style={[styles.table, { height: 60, marginTop: 10 }]}>
                    <View style={styles.tableRow}>
                ...
                <View style={[styles.table, { height: 70, marginTop: 5 }]}>
                    <View style={styles.tableRow}>
                ...
                <Text style={[styles.mainTitle, { marginTop: 15 }]}>Company Acknowledgment:</Text>
                <Text style={styles.paragraph}>
                ...
                <View style={{ marginTop: 15, borderTopWidth: 0.5, paddingTop: 5 }}>
                    <Text style={{ textAlign: 'center', fontSize: 7, color: '#666' }}>Computer generated document. Digitally approved by SHREEG EXPERT WEALTH.</Text>
                </View>
            </Page>
        </Document>
    );
